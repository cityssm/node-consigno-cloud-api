...
export function formatPhoneNumber(unformattedPhoneNumber) {
    ...
    const phoneExtension = formattedPhoneNumber.length > formattedPhoneNumberLength
        ? formattedPhoneNumber.slice(formattedPhoneNumberLength)
        : '';
    formattedPhoneNumber = formattedPhoneNumber.slice(0, formattedPhoneNumberLength);
    return {
